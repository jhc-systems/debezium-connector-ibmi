...
public class UpdateSingleRow {
    private static final Logger log = LoggerFactory.getLogger(UpdateSingleRow.class);
    String schema;
    String table;
    int start;
    int end;
    ...
    public UpdateSingleRow(Connection con, String schema, String table, int start, int end) {
        this.schema = schema;
        this.table = table;
        this.start = start;
        this.end = end;
