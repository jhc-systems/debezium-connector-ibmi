 ...
 * </pre>
 * 
 * See <a href="doc-files/JDBCProperties.html" target="_blank">JDBC
 * properties</a> for a complete list of properties supported by this driver.
 * 
 * <p>
 * The following example URL specifies a connection to the database on system
 * <em>mysystem.helloworld.com</em> with <em>mylibrary</em> as the default SQL
