...
//                                                                             
// Filename: AS400JDBCDriverForcedCcsid.java
//                                                                             
...
<a href="doc-files/JDBCProperties.html" target="_blank">JDBC properties</a>
	...
	**/
	...
	to call this method:
	<blockquote><pre>
	AS400JDBCDriverForcedCcsid d = new AS400JDBCDriverForcedCcsid();
  ...
  static String substitute (String text, Object[] values)
  {
        ...
        {                                                                         //@pw1
            ...
            {  //@pw3
                if (JDTrace.isTraceOn()) //jdbc category trace                        //@pw1
                    JDTrace.logInformation (AS400JDBCDriverForcedCcsid.class, "Userid/password cannot be \"\" or *CURRENT due to security constraints.  Use null instead");  //@pw1
	...
	**/
	...
	throws SQLException
	{
        ...
        if(!as400.arePropertiesFrozen()) //@timeout3 AS400JDBCDriverForcedCcsid.connect(clone=false) cannot update props. We don't know if DriverManager.setLoginTimeout() has been updated.
        {
            if(sockProps == null)
                sockProps = as400.getSocketProperties();
